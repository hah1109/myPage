...
public interface MemberMapper {
	...
	//member테이블에 정보 입력
	//@Insert("INSERT INTO member(mem_num,mem_id,mem_auth) VALUES (#{mem_num},#{mem_id},#{mem_auth})")쿼리문 밑에걸로 수정함
	...
	//t_num, mem_pic, mem_intro, mem_date 속성은 회원가입시 입력에서 제외해서 밑에 쿼리문으로 수정
	//mem_addr2를 eme_addr2로 썼던 오타 수정
