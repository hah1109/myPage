...
<body>
	<form id="report_submit" method="post" action="submitReport.do">
		...
		<input type="radio" name="alarm" value="욕설">욕설,비방,차별,혐오<br>
		...
		<input type="radio" name="alarm" value="7" id="others">기타<br>
		<textarea id="text" style="display:none;" placeholder="신고내용을 기재해주세요"></textarea><br>
